...
class Customer:
    ...
    def create_account(self, log_sign):
        self.name = log_sign.signup_name.get()
        self.username = log_sign.signup_username.get()
        self.password = log_sign.signup_password.get()
        self.password2 = log_sign.signup_password2.get()
        Customer.username=log_sign.signup_username.get()
        ...
        if not username_exists:
            ...
            OptionWindow(log_sign.root)  

    def login(self, log_sign):
        self.username = log_sign.login_username.get()
        self.password = log_sign.login_password.get()
        Customer.username= log_sign.login_username.get()
...
# a class which stores and displays customer's shopping
class ShoppingHistory(Customer):
    ...
    def view_history(self):
        ...
        history_label1 = Label(history_window, text='YOUR HISTORY', font=("Arial",12, "bold"))
        history_label1.pack(padx=10, pady=10)

        history_label2 = Label(history_window, text=history_text, justify='left', font=("Arial",8))
    ...
    def add_book(self, book):
        for item in self.books:
            if item['Book'] == book:
                ...
                return
        self.books.log_signend({'Book': book, 'Price': self.get_price(book)})
...
class OptionWindow:
    ...
    def go_to_menu(self):
        ...
        photo3 = load_image(file='5survive.png')
        ...
        photo4 = load_image(file='kiter.png')
        ...
        photo5 = load_image(file='atssuns.png')
        ...
        photo6 = load_image(file='inhgame.png')
        ...
        photo7 = load_image(file='thebookthief.png')
        ...
        photo8 = load_image(file='tbdate.png')
        ...
        photo9=load_image(file='alchem.png')
        ...
        photo10=load_image(file='nightc.png')
        ...
        photo11=load_image(file='wmerit.png')
        ...
        photo12=load_image(file='tuesdays.png')
        ...
        photo13=load_image(file='littlewm.png')
        ...
        photo14=load_image(file='verity.png')
...
class LoginSignup:
    ...
    def set_log_frame(self):
        ...
        login_button = tk.Button(self.login_frame, text="Login", command=self.call_login, width=20, height=2)
    ...
    def set_sign_frame(self):
        ...
        signup_button = tk.Button(self.signup_frame, text="Signup", command=self.call_signup, width=20, height=2)
...
def on_click():
    ...
    log_sign = LoginSignup(login_signup_window)
